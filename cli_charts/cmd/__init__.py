...
_MODULES = [
    ...
    "cli_charts.charts.series.event",
    "cli_charts.charts.series.sparkline", "cli_charts.charts.series.curve",
    "cli_charts.charts.series.step",
    # Phase 3b — media/ leaves
    "cli_charts.charts.media.bar",
    "cli_charts.charts.media.hbar",
    "cli_charts.charts.media.pie",
    "cli_charts.charts.media.table",
    "cli_charts.charts.media.tree",
    "cli_charts.charts.media.gauge",
    "cli_charts.charts.media.confusion",
    "cli_charts.charts.media.banner",
    "cli_charts.charts.media.art_command",
    "cli_charts.charts.media.diagram",
    "cli_charts.charts.media.mermaid",
    "cli_charts.charts.media.plotext",
    "cli_charts.charts.media.incplot",
    "cli_charts.charts.media.textplot",
    "cli_charts.charts.media.turtle",
    "cli_charts.charts.media.effect",
    "cli_charts.charts.media.uniplot",
    "cli_charts.charts.media.hires",
    "cli_charts.charts.media.radar",
    "cli_charts.charts.media.plotille_chart",
    "candlestick", "image", "video", "demo", "gallery",
    "code", "animate", "record", "record_replay",
    "to_hyperframes", "to_ascii_motion", "serve",
